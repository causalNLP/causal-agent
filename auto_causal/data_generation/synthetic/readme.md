...
```bash
bash auto_causal/data_generation/synthetic/create_synthetic_data_all.sh
```
...
```bash
bash auto_causal/data_generation/synthetic/create_context_all.sh
```
...
- Then run the following command:
  ```bash
  bash auto_causal/data_generation/synthetic/finalize_synthetic_dataset.sh
  ```
