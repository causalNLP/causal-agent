...
import causal_agent.components.output_formatter as cs_output_formatter
# Remove the direct import of cs_method_executor if it causes issues, we'll use importlib
# import causal_agent.tools.method_executor_tool as cs_method_executor
...
def main():
    ...
    try:
        method_executor_module_name = "causal_agent.tools.method_executor_tool"
