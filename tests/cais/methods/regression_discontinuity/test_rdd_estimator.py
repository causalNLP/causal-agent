...
from causal_agent.methods.regression_discontinuity.estimator import estimate_effect
...
def mock_causal_model():
    ...
    with patch('causal_agent.methods.regression_discontinuity.estimator.CausalModel') as MockCM:
...
@patch('causal_agent.methods.regression_discontinuity.estimator.run_rdd_diagnostics')
@patch('causal_agent.methods.regression_discontinuity.estimator.interpret_rdd_results')
...
@patch('causal_agent.methods.regression_discontinuity.estimator.estimate_effect_dowhy')
@patch('causal_agent.methods.regression_discontinuity.estimator.estimate_effect_fallback')
def test_estimate_effect_dowhy_fails_fallback_succeeds(mock_fallback, mock_dowhy, sample_rdd_data):
    ...
    with patch('causal_agent.methods.regression_discontinuity.estimator.run_rdd_diagnostics'), \
         patch('causal_agent.methods.regression_discontinuity.estimator.interpret_rdd_results'):
