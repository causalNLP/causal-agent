...
from causal_agent.models import LLMTreatmentReferenceLevel
...
def test_interpret_query_identifies_treatment_reference_level():
    ...
    with patch('causal_agent.components.query_interpreter._call_llm_for_var', side_effect=mock_llm_call_router) as mock_llm_call:
        ...
        with patch('causal_agent.components.query_interpreter.get_llm_client', return_value=mock_llm_instance) as mock_get_llm:
