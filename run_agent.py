...
def parse_args():
    ...
    parser.add_argument("--csv_meta", type=str, required=True, help="Path to the metadata CSV.")
    parser.add_argument("--data_dir", type=str, required=True, help="Path to the folder containing data CSVs.")
